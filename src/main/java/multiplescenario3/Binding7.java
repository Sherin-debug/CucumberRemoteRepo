...
public class Binding7 {
	public class BirdsBinding {
		...
		public String URL = "https://petstore.octoperf.com/";
	...
	public void i_clicked_add_to_cart() {
		By driver = null;
		driver.findElement((SearchContext) By.xpath("//a[text()='Add to Cart']")).click();
	}

	@Then("^I clicked on proceed to checkout$")
	public void i_clicked_on_proceed_to_checkout() {
		By driver = null;
		driver.findElement((SearchContext) By.xpath("//a[text()='Proceed to Checkout']")).click();
	}

	@And("^I clicked on continue$")
	    public void i_clicked_on_continue(){
       By driver = null;
	driver.findElement((SearchContext) By.xpath("//input[@value='Continue']")).click();}

	@And("^I clicked on confirm$")
	public void i_clicked_on_confirm() {
		By driver = null;
		driver.findElement((SearchContext) By.xpath("//a[text()='Confirm']")).click();
	}
